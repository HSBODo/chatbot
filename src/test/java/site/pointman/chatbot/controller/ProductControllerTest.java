...
class ProductControllerTest {
    ...
    void auth() throws Exception {
        mockMvc
                .perform(
                        post("/kakaochatbot/product/auth") // url
    ...
    void preview() throws Exception {
        mockMvc
                .perform(
                        post("/kakaochatbot/product/preview") // url
                                .contentType(MediaType.APPLICATION_JSON) // contentType 설정
                                .content(body) // body 데이터
                )
                .andDo(print()) // api 수행내역 로그 출력
    ...
    void add() throws Exception {
        mockMvc
                .perform(
                        post("/kakaochatbot/product/add") // url
                                .contentType(MediaType.APPLICATION_JSON) // contentType 설정
                                .content(body) // body 데이터
                )
                .andDo(print()) // api 수행내역 로그 출력
    ...
    void getProducts() throws Exception {
        mockMvc
                .perform(
                        post("/kakaochatbot/product/get") // url
                                .contentType(MediaType.APPLICATION_JSON) // contentType 설정
                                .content(body) // body 데이터
                )
                .andDo(print()) // api 수행내역 로그 출력
    ...
    void getProductDetail() throws Exception {
        mockMvc
                .perform(
                        post("/kakaochatbot/product/get/detail") // url
                                .contentType(MediaType.APPLICATION_JSON) // contentType 설정
                                .content(body) // body 데이터
                )
                .andDo(print()) // api 수행내역 로그 출력
    ...
    void updateProductStatus() throws Exception {
        mockMvc
                .perform(
                        post("/kakaochatbot/product/update/status") // url
                                .contentType(MediaType.APPLICATION_JSON) // contentType 설정
                                .content(body) // body 데이터
                )
                .andDo(print()) // api 수행내역 로그 출력
    ...
    void delete() throws Exception{
        mockMvc
                .perform(
                        post("/kakaochatbot/product/delete") // url
                                .contentType(MediaType.APPLICATION_JSON) // contentType 설정
                                .content(body) // body 데이터
                )
                .andDo(print()) // api 수행내역 로그 출력
