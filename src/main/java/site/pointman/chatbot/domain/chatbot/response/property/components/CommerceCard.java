package site.pointman.chatbot.domain.chatbot.response.property.components;
...
import site.pointman.chatbot.domain.chatbot.response.property.common.Thumbnail;
