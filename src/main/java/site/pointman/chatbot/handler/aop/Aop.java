package site.pointman.chatbot.handler.aop;
...
public class Aop {
    ...
    @Pointcut("execution(* site.pointman.chatbot.controller.kakaochatbot.*.*(..)) && (!@annotation(site.pointman.chatbot.handler.annotation.SkipLogging) ||  @annotation(site.pointman.chatbot.handler.annotation.ValidateMember))") //Pointcut
    public void chatBotControllerPointcut() {
    }

    @Pointcut("execution(* site.pointman.chatbot.controller.kakaochatbot.*.*(..)) && @annotation(site.pointman.chatbot.handler.annotation.ValidateMember)") //Pointcut
